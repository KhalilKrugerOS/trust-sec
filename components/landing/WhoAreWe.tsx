            ...
            <div className="relative z-10 flex flex-col md:flex-row gap-8 items-center h-full">
              ...
              <div className="flex-1 text-white">
                ...
                <p className="text-xl md:text-2xl leading-relaxed">
                  TrustSec&apos;s programs combine real-world scenarios,
                  hands-on labs, and expert-led sessions to build practical
                  skills in threat detection, data protection, and compliance.
                </p>
              </div>
            </div>
            ...
            <div className="relative z-10 p-8 flex flex-col justify-between h-full">
              <div className="text-white">
                ...
                <p className="text-xl md:text-2xl leading-relaxed max-w-xl">
                  ...
                  TrustSec provides expert training to help businesses and
                  professionals stay secure in a connected world.
                </p>
              </div>
