                ...
                <div className="absolute left-1/2 transform -translate-x-1/2 top-0">
                    <div className="relative">
                        ...
                        <div
                            ...
                            style={{
                                background: 'radial-gradient(circle at 0 100%, transparent 9px, white 10px)'
                            }}
                        />
                        ...
                        <div
                            ...
                            style={{
                                background: 'radial-gradient(circle at 100% 100%, transparent 9px, white 10px)'
                            }}
                        />
                    </div>
                </div>
            ...
            <div className="relative container mx-auto px-4 pt-20 pb-8 w-full">
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="text-white space-y-4 mb-16">
                        <p className="text-3xl md:text-4xl font-normal">Welcome to TrustSec !</p>
